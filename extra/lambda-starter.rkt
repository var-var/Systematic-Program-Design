...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname lambda-starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)

;; Number (listof Number) -> (listof Number)
;; produce only elements of lon > theshold
